...
############################### Module Starts Here ###########################
  ...
  sub to_verilog{ 
	...
	$self->SUPER::to_verilog('/nobackup/steveri/github/fftgen/rtl/fftctl_old.vp');
# START USER CODE FROM /nobackup/steveri/github/fftgen/rtl/fftctl_old.vp PARSED INTO PACKAGE >>>
# line 1 "/nobackup/steveri/github/fftgen/rtl/fftctl_old.vp"
...
print { $Genesis2::UniqueModule::myself->{OutfileHandle} } '///////////////////////////////////////////////////////////////////////////////';print { $Genesis2::UniqueModule::myself->{OutfileHandle} } "\n"; 
# <<< END USER CODE FROM /nobackup/steveri/github/fftgen/rtl/fftctl_old.vp PARSED INTO PACKAGE
